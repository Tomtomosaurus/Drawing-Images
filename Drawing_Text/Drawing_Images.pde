...
void setup()
{
  ...
  //
  //Population
  pic = loadImage("../Images Used/Landscape/Kool_Kat.jpg");
  pic2 = loadImage("../Images Used/Landscape/Kool_Kat.jpg");
  pic3 = loadImage("../Images Used/Portrait/Phone Background.jpg");
